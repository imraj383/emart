...
public class DBconnection {
   ...
   static {
       try{
           ...
           conn=DriverManager.getConnection("jdbc:oracle:thin:@//LAPTOP-9GSH1AN6:1521/xe","priyanshuraj","imraj");
           ...
           JOptionPane.showMessageDialog(null, "Error in opening connection","error in opening connection",JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
           System.exit(1);
       }
   }
